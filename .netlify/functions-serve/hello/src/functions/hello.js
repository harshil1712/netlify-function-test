...
var import_crypto, carriage, dashes, carriageLength, getFooter, getBoundary;
...
var import_stream, import_util, INTERNALS, Body, clone, extractContentType, getTotalBytes, writeToStream;
var init_body = __esm({
  "node_modules/node-fetch/src/body.js"() {
...
var import_util2, import_http, validateHeaderName, validateHeaderValue, Headers;
...
var import_url, INTERNALS3, isRequest, Request, getNodeRequestOptions;
...
var import_http2, import_https, import_zlib, import_stream2, import_data_uri_to_buffer, supportedSchemas;
var init_src = __esm({
  "node_modules/node-fetch/src/index.js"() {
    ...
    import_data_uri_to_buffer = __toModule(require_src());
    init_body();
    init_response();
    init_headers();
    init_request();
...
exports.handler = async function(event, context) {
  ...
  const response = await fetch2("https://n8n.app.harshil.dev/webhook/url", {
    method: "POST",
